...
namespace Otus.Teaching.Pcf.Administration.WebHost.Controllers
{
        ...
        : ControllerBase
    {
        ...
        private readonly ApplyPromocodesService _applyPromocodesService;

        public EmployeesController(IRepository<Employee> employeeRepository, ApplyPromocodesService applyPromocodesService)
        {
            _employeeRepository = employeeRepository;
            _applyPromocodesService = applyPromocodesService;
        }
        ...
        {
            var isAppliedPromocodes = await _applyPromocodesService.UpdateAppliedPromocodesAsync(id);
            if (!isAppliedPromocodes) return NotFound();
